...
class Main {
	...
	private function set_locale() {
		...
		$plugin_i18n->set_domain( $this->get_revmakx() );
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new admin\Controller( $this->get_revmakx(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new front\Controller( $this->get_revmakx(), $this->get_version() );
